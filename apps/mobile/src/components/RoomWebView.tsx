...
// 2. 点击事件拦截：重写 target 为 _self，并对非房主进行阻断
    ...
    <View style={styles.container}>
      ...
      <RNCWebView
        ...
        onOpenWindow={(syntheticEvent: any) => {
          ...
          if (targetUrl && !targetUrl.startsWith('about:blank')) {
            if (!isHost) {
      ...
      >
        <TouchableOpacity 
          ...
          activeOpacity={0.7}
        >
          <Lamp color={(showControls || isPortraitPanelExpanded) ? "#F97316" : "rgba(255, 255, 255, 0.85)"} size={18} />
        </TouchableOpacity>
      </Animated.View>
