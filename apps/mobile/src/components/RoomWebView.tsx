  ...
  return (
    <View style={styles.container}>
      ...
      <RNCWebView
        ...
        injectedJavaScriptBeforeContentLoaded={`window.__isHost = ${isHost}; try { window.open = function(url) { if (url) { if (window.__isHost === false) { if (window.ReactNativeWebView) { window.ReactNativeWebView.postMessage(JSON.stringify({ type: 'HOST_ONLY_WARNING', message: '只有房主可以点击链接跳转' })); } return null; } window.location.href = url; } return window; }; } catch(e){} true;`}
