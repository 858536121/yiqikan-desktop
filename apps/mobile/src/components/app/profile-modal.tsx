...
import { StyleSheet, View, Text, Modal, TouchableOpacity, Alert, TextInput, ActivityIndicator, Linking, Platform } from 'react-native';
            ...
            {downloadProgress !== null && (
              <View style={styles.inlineProgressContainer}>
                <View style={styles.inlineProgressBar}>
                  <View style={[styles.inlineProgressFill, { width: `${downloadProgress}%` }]} />
                </View>
              </View>
            )}
