...
export function GestureSeekHud({
  ...
  const showHours = (duration >= 3600) || (targetTime >= 3600);
    ...
    <View style={styles.hudContainer} pointerEvents="none">
      <View style={styles.hudCard}>
        ...
        <Text style={styles.timeText}>
          <Text style={styles.currentTimeText}>{formatTime(targetTime, showHours)}</Text>
          <Text style={styles.durationText}> / {formatTime(duration, showHours)}</Text>
        </Text>
