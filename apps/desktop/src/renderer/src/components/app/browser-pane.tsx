    ...
    <>
              ...
              <div className="relative shrink-0">
                ...
                {menuOpen && (
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-1 z-50 min-w-[140px] overflow-hidden rounded-md border border-white/10 bg-[#0e0e10]/95 shadow-2xl backdrop-blur-md">
                      <button
      ...
      {collapsed && (
        <button
          ...
          className={cn(
            "fixed z-50 flex h-12 w-12 cursor-grab select-none items-center justify-center rounded-2xl border border-orange-500/20 bg-surface/90 text-white shadow-lg backdrop-blur-md transition-all duration-500 hover:scale-105 active:cursor-grabbing",
            lampFaded ? "opacity-15" : "opacity-100",
          )}
