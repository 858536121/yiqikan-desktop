    ...
    <>
      ...
      {collapsed && (
        <button
          ...
          className="fixed z-50 flex h-10 w-10 cursor-grab select-none items-center justify-center rounded-xl border border-white/[0.12] bg-[#111113]/90 text-white shadow-lg backdrop-blur-md transition-all duration-150 hover:-translate-x-0.5 hover:bg-zinc-800 active:cursor-grabbing"
          style={{ top: collapsedToggleTop, left: collapsedToggleLeft, touchAction: "none" }}
          title="展开面板"
        >
          <span className="pointer-events-none absolute inset-0 rounded-xl bg-gradient-to-br from-orange-500/15 via-transparent to-rose-500/10" />
          <ChevronLeft className="relative z-10 h-[18px] w-[18px] text-white" />
          {hasUnreadChat && (
