                      ...
                      <div className="rounded-lg border border-white/[0.06] bg-white/[0.03] px-2.5 py-2.5">
                        <div className="mb-2 flex items-center justify-between gap-2">
                          ...
                          <span className={cn(
                            ...
                            room.publicMeta?.isPublic ? "bg-green-500/15 text-green-300" : "bg-white/[0.06] text-zinc-500",
                          )}>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-2">
                            {room.publicMeta?.isPublic ? (
                              <Button variant="secondary" className="h-8 flex-1 text-xs" onClick={() => onUpdatePublicRoom(false)}>从大厅下架</Button>
                            ) : (
                              <Button
                            ...
                            {!desktopAuth && !room.publicMeta?.isPublic && (
                              <Button variant="ghost" className="h-8 px-2 text-xs" onClick={onStartDesktopLogin}>
                                <LogIn className="h-3.5 w-3.5" />
                              </Button>
                            )}
                          </div>
                          {room.hasPassword ? (
                            <p className="text-[10px] leading-4 text-zinc-500">公开房间第一版不支持密码房，请先移除房间密码。</p>
                          ) : null}
                        </div>
                      </div>
                    )}
