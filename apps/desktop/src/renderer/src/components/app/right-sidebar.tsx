  ...
  return (
    <aside className="h-screen w-[340px] border-l border-white/[0.08] bg-[#111113] transition-all duration-300 flex flex-col shrink-0">
      ...
      <div className="flex items-center gap-2 px-3 py-2.5 border-b border-white/[0.08] shrink-0">
        ...
        <Button
          variant="ghost"
          className="shrink-0 w-7 h-7 p-0 rounded-lg text-zinc-400 hover:text-white"
                        ...
                        <button
                          className={cn(
                            ...
                            room.publicMeta?.isPublic
                              ? "border-green-500/25 bg-green-500/15 text-green-400 hover:bg-green-500/25"
                              : "border-white/10 bg-white/4 text-zinc-500 hover:bg-white/[0.08] hover:text-white"
                          )}
                          onClick={(e) => {
                            if (isPublicMenuOpen) {
                            ...
                            setOpenPublicMenuPos({ x: rect.right - 260, y: rect.bottom + 8 });
                            setIsPublicMenuOpen(true);
                          }}
                          title={room.publicMeta?.isPublic ? "大厅设置 (已公开)" : "大厅设置 (未公开)"}
                        >
                          <MonitorPlay className="w-3.5 h-3.5" />
                          {room.publicMeta?.isPublic && (
                            <span className="absolute -top-1 -right-1 h-2 w-2 rounded-full bg-green-500 shadow-[0_0_4px_#22c55e]" />
                          )}
                        </button>
                      )}
                    </div>
