...
// Auto-respond to extension ping from web room so web-room naturally detects desktop environment
window.addEventListener("message", (event) => {
  if (event.data?.source === "yiqikan-ping") {
    window.postMessage({ source: "yiqikan-pong", version: desktopRuntimeContext.client.appVersion, isDesktop: true }, "*");
  }
});
